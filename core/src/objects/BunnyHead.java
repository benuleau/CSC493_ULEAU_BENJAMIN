...
public class BunnyHead extends AbstractGameObject {
	...
	public void init() {
		...
		// Particles
		// dustParticles.load(Gdx.files.internal("particles/particles.pafx"),
		// Gdx.files.internal("particles"));
		dustParticles.load(
				Gdx.files.internal(
						"/Users/benuleau/Desktop/School/JuniorS1/CSC493/CSC493_ULEAU_BENJAMIN/core/assets/particles/particles.pafx"),
				Gdx.files.internal(
	...
	public void update(float deltaTime) {
		...
		if (timeLeftFeatherPowerup > 0) {
			if (animation == animCopterTransformBack) {
				// Restart "Transform" animation if another feather powerup was
				// picked
				// up during "TransformBack" animation. Otherwise, the
				// "TransformBack"
				// animation would be stuck while the powerup is still active
		...
		// Change animation state according to feather powerup
	...
	public void render(SpriteBatch batch) {
		...
		/*
		 * // Set special color when game object has a feather power-up float
		 * relX = 0; float relY=0;
		 * 
		...
		// reg.getRegionWidth(),reg.getRegionHeight(), viewDirection ==
		// VIEW_DIRECTION.LEFT,false);
